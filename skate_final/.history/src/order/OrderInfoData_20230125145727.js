        ...
        <div>
            {commandes.map((commande) => (
                <div className='invoice-table' key={commande.id}>
                    ...
                    {commande.attributes.commande.data.id == id ? <p>{commande.attributes.produit.data.attributes.quantite}</p> : null}
                    {commande.attributes.commande.data.id == id ? <p>{commande.attributes.produit.data.attributes.prix}</p> : null} */}
                </div>
            ))}
        </div>
    )

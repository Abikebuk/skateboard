                    ...
                    <div className="scrollbar-container app-sidebar-content ps">
                        ...
                        <div className="menu">
                            ...
                            <div className="menu-item">
                                <a className="menu-link" href="http://localhost:3000/dashboard/v1">
                            ...
                            <div className="menu-item has-sub">
                                <a className="menu-link" href="http://localhost:3000/chart">
                                    <div className="menu-icon"><i className="fa fa-chart-pie"></i></div>
                                    <div className="menu-text">Panier</div>
                                </a>
                            </div>

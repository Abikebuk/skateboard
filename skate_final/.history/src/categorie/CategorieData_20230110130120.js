            ...
            {categories?.map((categorie) => (
                <div className='grid__user__categorie' key={categorie.id}>
                    ...
                    <p className="form-switch grid__center">
                        ...
                        <input className="form-check-input form-switch" type="checkbox" role="switch" id="flexSwitchCheckDefault" onChange={!categorie.attributes.etatCategorie} onClick={(e) => handleUpdate(e, categorie.id)} checked={categorie.attributes.etatCategorie}  />

...
function CategorieData() {
    ...
    function handleUpdate(e, id) {
        ...
        axios.put(url.api_url_local + '/categories/' + id, data)
            .then(res => {
                console.log(res)
                // setValues.etatCategorie(false)
                // setValues(values.etatCategorie = !values.etatCategorie)
            })
            .catch(err => {
                console.log(err)
            })
            ...
            {categories?.map((categorie) => (
                <div className='grid__user__categorie' key={categorie.id}>
                    ...
                    <p className="form-switch grid__center">
                        ...
                        <input className="form-check-input form-switch" type="checkbox" role="switch" id="flexSwitchCheckDefault" onClick={(e) => handleUpdate(e, categorie.id)} value={values.etatCategorie == true ? checked : null} />
                    </p>

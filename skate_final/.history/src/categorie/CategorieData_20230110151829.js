...
function CategorieData() {
    ...
    async function handleUpdate(e, id) {
        ...
        try {
        const res = axios.put(url.api_url_local + '/categories/' + id, data)
        console.log(res.data.data.attributes.json())
        // const newCategories = await res.json()
        // setCategories(oldCategories => [...oldCategories ,newCategories])

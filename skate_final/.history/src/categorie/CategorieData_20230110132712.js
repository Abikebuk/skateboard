            ...
            {categories?.map((categorie) => (
                <div className='grid__user__categorie' key={categorie.id}>
                    ...
                    <p className="form-switch grid__center">
                        ...
                        <form>
                        <input className="form-check-input form-switch" type="checkbox" role="switch" id="flexSwitchCheckDefault" onClick={() => setValues({etatCategorie: !categorie.attributes.etatCategorie})} checked={categorie.attributes.etatCategorie} />
                        {console.log(values.etatCategorie)}
                        </form>
                    </p>

...
function CategorieData() {
    ...
    function handleUpdate(e, id) {
        ...
        axios.put(url.api_url_local + '/categories/' + id, data)
            .then(res => {
                const val = res.data.data.attributes.etatCategorie
                console.log(...values[values.etatCategorie])

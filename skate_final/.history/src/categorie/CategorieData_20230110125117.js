...
function CategorieData() {
    ...
    function handleUpdate(e, id) {
        ...
        const data = {
            "data": {
                etatCategorie: setValues({etatCategorie: e.target.checked})
            }
        }
            ...
            {categories?.map((categorie) => (
                <div className='grid__user__categorie' key={categorie.id}>
                    ...
                    <p className="form-switch grid__center">
                        ...
                        <input className="form-check-input form-switch" type="checkbox" role="switch" id="flexSwitchCheckDefault" onChange={(e) => handleUpdate(e, categorie.id)} />

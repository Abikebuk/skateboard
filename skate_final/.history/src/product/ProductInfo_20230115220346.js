                                ...
                                <div className="mb-3">
                                    ...
                                    />
                                        <div className="mb-3">
                                            ...
                                            <input id="title" value={values.title} type="text" placeholder="titre" className="form-control" name="title" />
                                        </div>
                                        <div className="mb-3">
                                            <label className="form-label">Déscripton</label>
                                            <input id="title" value={values.title} type="text" className="form-control" name="title" placeholder="Product name" />
                                        </div>
                                        <div className="mb-3">
                                            <label className="form-label">Prix</label>
                                            <input id="title" value={values.title} type="text" className="form-control" name="title" placeholder="Prix du produit" />
                                        </div>
                                    </div>

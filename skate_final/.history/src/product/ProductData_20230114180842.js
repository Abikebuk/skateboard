        ...
        <div className='grid__user__product'>
            {products?.map((product) => (
                <div className='grid__user__categorie' key={product.id}>
                    <img className='grid-picproduct' src={url.api_url_local + '/' + product.attributes.image.data.attributes.formats.thumbnail.url} alt='sakte' />
                    {console.log(product.attributes.image.data.attributes.formats.thumbnail.url)}

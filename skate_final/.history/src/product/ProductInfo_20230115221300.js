                                ...
                                <div className="mb-3">
                                    ...
                                    />
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input id="title" value={values.description} type="text" className="form-control" name="title" placeholder="Déscription du produit" />
                                        </div>
                                        <div className="mb-3">
                                            <label className="form-label">Prix</label>
                                            <input id="title" value={values.prix} type="text" className="form-control" name="title" placeholder="Prix du produit" />
                                        </div>
                                        <div className="mb-3">
                                            <label className="form-label">Quantité</label>
                                            <input id="title" value={values.quantite} type="text" className="form-control" name="title" placeholder="Quantité du produit" />
                                        </div>
                                        <div className="mb-3">
                                            <label className="form-label">Référence</label>
                                            <input id="title" value={values.ref} type="text" className="form-control" name="title" placeholder="Référence du produit" />
                                        </div>
                                    </div>

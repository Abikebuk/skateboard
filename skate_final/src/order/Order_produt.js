...
function Order_produt() {
    ...
    const handleTest = (e) => {
        //et la tu fais un post ou tu récupere la list et l'id de la commande {ids} tu mets ça dans la table ProductSell
    }
                    ...
                    <div className="table-responsive">
                        ...
                        <div className="card-body">
                            <form className='col-lg-8' onSubmit={handleCreate}>
                                ...
                                <input type="submit" onClick={handleTest()} className="btn btn-secondary" value="Enregister" />
                            </form>
                        </div>
                    </div>
